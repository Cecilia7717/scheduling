...
def read_gpu_times(results_csv: Path):
    """
    Read wall_ms from one experiment's results.csv.
    ...
    with results_csv.open("r", newline="", encoding="utf-8") as f:
        ...
        if "wall_ms" not in reader.fieldnames:
            raise ValueError(
                f"{results_csv} does not contain wall_ms.\n"
...
def main():
    ...
    parser.add_argument(
        "--root",
        type=str,
        default="job_interval_scaling_results_gpu_ecl_timing_adjusted",
        help=(
